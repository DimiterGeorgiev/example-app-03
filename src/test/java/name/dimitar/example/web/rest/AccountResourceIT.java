...
import static name.dimitar.example.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import name.dimitar.example.repository.AuthorityRepository;
...
import name.dimitar.example.service.dto.PasswordChangeDTO;
import name.dimitar.example.service.dto.UserDTO;
import name.dimitar.example.web.rest.vm.KeyAndPasswordVM;
import name.dimitar.example.web.rest.vm.ManagedUserVM;

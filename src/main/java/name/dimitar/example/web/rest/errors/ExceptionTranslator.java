package name.dimitar.example.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof name.dimitar.example.service.EmailAlreadyUsedException ||
            ex instanceof name.dimitar.example.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof name.dimitar.example.service.InvalidPasswordException
